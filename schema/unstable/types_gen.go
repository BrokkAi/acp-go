// Code generated by acpgen from ACP JSON Schema release schema-v1.23.0-unstable (wire types). DO NOT EDIT.
...
func (v *NesSuggestion) UnmarshalJSON(data []byte) error {
	...
	*v = NesSuggestion{}
	...
	default:
		return fmt.Errorf("NesSuggestion: unknown kind tag %q", tag)
	}
}
...
func (v *PlanUpdateContent) UnmarshalJSON(data []byte) error {
	...
	*v = PlanUpdateContent{}
	...
	default:
		return fmt.Errorf("PlanUpdateContent: unknown type tag %q", tag)
	}
}
