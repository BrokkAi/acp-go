// Code generated by acpgen from ACP JSON Schema release schema-v2.0.0-alpha.5-unstable (wire types). DO NOT EDIT.
...
const (
	...
	McpServerKindAcp   McpServerKind = "acp"
...
func (v McpServer) MarshalJSON() ([]byte, error) {
	...
	if v.ACP != nil {
		if tag, err := json.Marshal("acp"); err != nil {
			return nil, err
		} else {
			obj["type"] = tag
		}
		payload, err := json.Marshal(v.ACP)
		if err != nil {
			return nil, err
		}
		var fields map[string]json.RawMessage
...
func (v *McpServer) UnmarshalJSON(data []byte) error {
	...
	*v = McpServer{}
	...
	case "acp":
		v.Kind = McpServerKindAcp
		v.ACP = new(McpServerAcp)
		return json.Unmarshal(data, v.ACP)
	case "stdio":
...
type MessageMcpNotification struct {
	...
	Params Nullable[map[string]any] `json:"params,omitzero"`
}
...
type NesEditHistoryCapabilities struct {
	...
	MaxCount Nullable[uint32] `json:"maxCount,omitzero"`
}
...
type NesOpenFile struct {
	...
	LastFocusedMs Nullable[uint64] `json:"lastFocusedMs,omitzero"`
	// The URI of the file.
	URI string `json:"uri"`
...
type NesSearchAndReplaceSuggestion struct {
	...
	IsRegex Nullable[bool] `json:"isRegex,omitzero"`
...
type NesSuggestContext struct {
	...
	Diagnostics Nullable[[]NesDiagnostic] `json:"diagnostics,omitzero"`
	// Recent edit history.
	EditHistory Nullable[[]NesEditHistoryEntry] `json:"editHistory,omitzero"`
	// Currently open files in the editor.
	OpenFiles Nullable[[]NesOpenFile] `json:"openFiles,omitzero"`
	// Recently accessed files.
	RecentFiles Nullable[[]NesRecentFile] `json:"recentFiles,omitzero"`
	// Related code snippets.
	RelatedSnippets Nullable[[]NesRelatedSnippet] `json:"relatedSnippets,omitzero"`
	// Recent user actions (typing, navigation, etc.).
	UserActions Nullable[[]NesUserAction] `json:"userActions,omitzero"`
}

// A suggestion returned by the agent.
type NesSuggestionKind string

const (
	NesSuggestionKindEdit             NesSuggestionKind = "edit"
	NesSuggestionKindJump             NesSuggestionKind = "jump"
	NesSuggestionKindRename           NesSuggestionKind = "rename"
	NesSuggestionKindSearchandreplace NesSuggestionKind = "searchAndReplace"
)

// NesSuggestion is a tagged union discriminated by "kind".
// Exactly one variant pointer must be set. Kind is set on decode and
// derived from the payload on encode; setting it by hand has no effect.
type NesSuggestion struct {
	Kind             NesSuggestionKind              `json:"-"`
	Edit             *NesEditSuggestion             `json:"-"`
	Jump             *NesJumpSuggestion             `json:"-"`
	Rename           *NesRenameSuggestion           `json:"-"`
	SearchAndReplace *NesSearchAndReplaceSuggestion `json:"-"`
	Other            *NesSuggestionOther            `json:"-"`
}

// NesSuggestionOther preserves an unrecognized NesSuggestion payload verbatim.
type NesSuggestionOther struct{ Raw json.RawMessage }

func (v NesSuggestionOther) MarshalJSON() ([]byte, error) { return v.Raw, nil }
...
func (v NesSuggestion) MarshalJSON() ([]byte, error) {
	...
	if set != 1 {
		return nil, fmt.Errorf("%s: exactly one variant must be set, have %d", "NesSuggestion", set)
	}
	if v.Edit != nil {
		if tag, err := json.Marshal("edit"); err != nil {
			return nil, err
		} else {
			obj["kind"] = tag
		}
		payload, err := json.Marshal(v.Edit)
		if err != nil {
			return nil, err
		}
		var fields map[string]json.RawMessage
		if err := json.Unmarshal(payload, &fields); err != nil {
			return nil, fmt.Errorf("NesSuggestion payload: %w", err)
		}
		for k, raw := range fields {
			obj[k] = raw
		}
	...
	if v.Jump != nil {
		if tag, err := json.Marshal("jump"); err != nil {
			return nil, err
		} else {
			obj["kind"] = tag
		}
		payload, err := json.Marshal(v.Jump)
		if err != nil {
			return nil, err
		}
		var fields map[string]json.RawMessage
	...
	if v.Rename != nil {
		if tag, err := json.Marshal("rename"); err != nil {
			return nil, err
		} else {
			obj["kind"] = tag
		}
		payload, err := json.Marshal(v.Rename)
		if err != nil {
			return nil, err
		}
		var fields map[string]json.RawMessage
	...
	if v.SearchAndReplace != nil {
		if tag, err := json.Marshal("searchAndReplace"); err != nil {
			return nil, err
		} else {
			obj["kind"] = tag
		}
		payload, err := json.Marshal(v.SearchAndReplace)
		if err != nil {
			return nil, err
		}
		var fields map[string]json.RawMessage
...
func (v *NesSuggestion) UnmarshalJSON(data []byte) error {
	var raws map[string]json.RawMessage
	if err := json.Unmarshal(data, &raws); err != nil {
		return err
	}
	*v = NesSuggestion{}
	var tag string
	if raw, ok := raws["kind"]; ok {
		if err := json.Unmarshal(raw, &tag); err != nil {
			return fmt.Errorf("NesSuggestion tag: %w", err)
		}
	}
	switch tag {
	case "edit":
		v.Kind = NesSuggestionKindEdit
		v.Edit = new(NesEditSuggestion)
		return json.Unmarshal(data, v.Edit)
	case "jump":
		v.Kind = NesSuggestionKindJump
		v.Jump = new(NesJumpSuggestion)
		return json.Unmarshal(data, v.Jump)
	case "rename":
		v.Kind = NesSuggestionKindRename
		v.Rename = new(NesRenameSuggestion)
		return json.Unmarshal(data, v.Rename)
	case "searchAndReplace":
		v.Kind = NesSuggestionKindSearchandreplace
		v.SearchAndReplace = new(NesSearchAndReplaceSuggestion)
		return json.Unmarshal(data, v.SearchAndReplace)
	default:
		v.Kind = NesSuggestionKind(tag)
		v.Other = &NesSuggestionOther{Raw: append(json.RawMessage(nil), data...)}
		return nil
	}
}
...
const (
	...
	PlanUpdateContentKindFile     PlanUpdateContentKind = "file"
	PlanUpdateContentKindMarkdown PlanUpdateContentKind = "markdown"
)
...
func (v PlanUpdateContent) MarshalJSON() ([]byte, error) {
	...
	if v.File != nil {
		if tag, err := json.Marshal("file"); err != nil {
			return nil, err
		} else {
			obj["type"] = tag
		}
		payload, err := json.Marshal(v.File)
		if err != nil {
			return nil, err
		}
		var fields map[string]json.RawMessage
	...
	if v.Markdown != nil {
		if tag, err := json.Marshal("markdown"); err != nil {
			return nil, err
		} else {
			obj["type"] = tag
		}
		payload, err := json.Marshal(v.Markdown)
		if err != nil {
			return nil, err
		}
		var fields map[string]json.RawMessage
...
func (v *PlanUpdateContent) UnmarshalJSON(data []byte) error {
	...
	*v = PlanUpdateContent{}
	...
	case "file":
		v.Kind = PlanUpdateContentKindFile
		v.File = new(PlanFile)
		return json.Unmarshal(data, v.File)
	case "markdown":
		v.Kind = PlanUpdateContentKindMarkdown
		v.Markdown = new(PlanMarkdown)
		return json.Unmarshal(data, v.Markdown)
	default:
...
const (
	...
	SessionUpdateKindPlanRemoved             SessionUpdateKind = "plan_removed"
	...
	SessionUpdateKindNotice                  SessionUpdateKind = "notice"
	SessionUpdateKindCompactionUpdate        SessionUpdateKind = "compaction_update"
	SessionUpdateKindCompactionSummaryChunk  SessionUpdateKind = "compaction_summary_chunk"
)
...
type SessionUpdate struct {
	...
	Notice                  *Notice                  `json:"-"`
	CompactionUpdate        *CompactionUpdate        `json:"-"`
	CompactionSummaryChunk  *CompactionSummaryChunk  `json:"-"`
...
func (v SessionUpdate) MarshalJSON() ([]byte, error) {
	...
	if v.CompactionUpdate != nil {
		set++
	}
	if v.CompactionSummaryChunk != nil {
		set++
	}
	if v.Other != nil {
		set++
	...
	if v.PlanRemoved != nil {
		if tag, err := json.Marshal("plan_removed"); err != nil {
			return nil, err
		} else {
			obj["sessionUpdate"] = tag
		}
		payload, err := json.Marshal(v.PlanRemoved)
		if err != nil {
			return nil, err
		}
		var fields map[string]json.RawMessage
	...
	if v.Notice != nil {
		if tag, err := json.Marshal("notice"); err != nil {
			return nil, err
		} else {
			obj["sessionUpdate"] = tag
		}
		payload, err := json.Marshal(v.Notice)
		if err != nil {
			return nil, err
		}
		var fields map[string]json.RawMessage
	...
	if v.CompactionUpdate != nil {
		if tag, err := json.Marshal("compaction_update"); err != nil {
			return nil, err
		} else {
			obj["sessionUpdate"] = tag
		}
		payload, err := json.Marshal(v.CompactionUpdate)
		if err != nil {
			return nil, err
		}
		var fields map[string]json.RawMessage
	...
	if v.CompactionSummaryChunk != nil {
		if tag, err := json.Marshal("compaction_summary_chunk"); err != nil {
			return nil, err
		} else {
			obj["sessionUpdate"] = tag
		}
		payload, err := json.Marshal(v.CompactionSummaryChunk)
		if err != nil {
			return nil, err
		}
		var fields map[string]json.RawMessage
...
func (v *SessionUpdate) UnmarshalJSON(data []byte) error {
	...
	*v = SessionUpdate{}
	...
	case "plan_removed":
		v.Kind = SessionUpdateKindPlanRemoved
		v.PlanRemoved = new(PlanRemoved)
		return json.Unmarshal(data, v.PlanRemoved)
	...
	case "notice":
		v.Kind = SessionUpdateKindNotice
		v.Notice = new(Notice)
		return json.Unmarshal(data, v.Notice)
	case "compaction_update":
		v.Kind = SessionUpdateKindCompactionUpdate
		v.CompactionUpdate = new(CompactionUpdate)
		return json.Unmarshal(data, v.CompactionUpdate)
	case "compaction_summary_chunk":
		v.Kind = SessionUpdateKindCompactionSummaryChunk
		v.CompactionSummaryChunk = new(CompactionSummaryChunk)
		return json.Unmarshal(data, v.CompactionSummaryChunk)
	default:
...
type StartNesRequest struct {
	...
	WorkspaceURI Nullable[string] `json:"workspaceUri,omitzero"`
}
...
type Usage struct {
	...
	CachedReadTokens Nullable[uint64] `json:"cachedReadTokens,omitzero"`
	// Total cache write tokens.
	CachedWriteTokens Nullable[uint64] `json:"cachedWriteTokens,omitzero"`
	// Total input tokens.
	InputTokens uint64 `json:"inputTokens"`
	// Total output tokens.
	OutputTokens uint64 `json:"outputTokens"`
	// Total thought/reasoning tokens
	ThoughtTokens Nullable[uint64] `json:"thoughtTokens,omitzero"`
